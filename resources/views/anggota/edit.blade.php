        ...
        <div class="row justify-content-center align-items-center">
            <div class="card" style="width: 24rem;">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ route('anggota.update', $Anggota->Nim) }}" id="myForm" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="Gambar">gambar: </label> <input type="file" class="form-control"
                                name="Gambar"><br>
