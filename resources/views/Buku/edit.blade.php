                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_buku" class="form-control" id="kode_buku"
                            value="{{ $bukus->kode_buku }}" aria-describedby="kode_buku">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="no_rak" name="no_rak" class="form-control" id="no_rak" value="{{ $bukus->no_rak }}"
                            aria-describedby="no_rak">
                    </div>
                    <div class="form-group">
                        <label for="tahun">Tahun Terbit</label>
                        <input type="tahun" name="tahun" class="form-control" id="tahun" value="{{ $bukus->tahun }}"
